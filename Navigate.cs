...
namespace Bibiotekav2
{
    ...
    {
        //Nawigacje:
        public static string[] MainNav = { "1 - Przeloguj się", "2 - Pokaż książki", "3 - Wypożycz książki", "Q - Wyjście" };
        public static string[] Main_Admin = { "1 - Zaloguj się", "2 - Pokaż książki", "3 - Pokaż użytkowników", "Q - Wyjście" };
